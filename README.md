...
Neste trabalho prático (TP1), foram implementadas as funcionalidades básicas de cadastro, autenticação e gerenciamento de cursos. A funcionalidade de inscrições será implementada no TP2.
